...
/* Поверхности (Pure Hi-Fi Charcoal / True Neutral Dark Gray) */
--c-bg-0            /* #0D0D0D - глубочайший фон холста/подложки */
--c-bg-1            /* #121212 - базовый нейтральный фон приложения */
--c-bg-2            /* #1A1A1A - приподнятые карточки и панели */
--c-bg-3            /* #222222 - интерактивные поверхности, колодцы и ховеры */
--c-bg-4            /* #2A2A2A - активные поверхности и кнопки */

/* Текст (Нейтральные оттенки серого — без синевы) */
--c-text-1          /* #FFFFFF - основной контрастный белый */
--c-text-2          /* #B3B3B3 - вторичный нейтральный светло-серый */
--c-text-3          /* #808080 - приглушенный нейтральный */
--c-text-4          /* #555555 - отключенный / метки */
```
