<template>
  <aside class="sidebar">
    ...
    <div class="sidebar-logo">
      ...
      <span class="logo-text">TG Player</span>
    </div>
    ...
    <nav class="sidebar-nav">
      <router-link to="/" class="nav-item" :class="{ active: isActive('/') }">
        ...
        <span v-if="trackCount" class="nav-count">{{ trackCount }}</span>
      </router-link>
      ...
      <router-link to="/liked" class="nav-item" :class="{ active: isActive('/liked') }">
        ...
        <span>Любимое</span>
        <span v-if="likedCount" class="nav-count">{{ likedCount }}</span>
      </router-link>
      ...
      <router-link to="/artists" class="nav-item" :class="{ active: isActive('/artists') }">
        ...
        <span>Артисты</span>
        <span v-if="artistCount" class="nav-count">{{ artistCount }}</span>
      </router-link>
    ...
    <!-- Divider -->
    <div v-if="displayedAlbums.length > 0" class="sidebar-divider"></div>

    <!-- Playlists Section -->
    <div class="sidebar-section playlists-section">
      <div class="section-header">
        <span class="section-title clickable" @click="$router.push('/playlists')">Плейлисты</span>
      </div>
    ...
    <div class="sidebar-footer">
      ...
      <router-link to="/settings" class="settings-btn" title="Настройки">
