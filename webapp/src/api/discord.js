...
export const discordApi = {
  ...
  connect: (channelId) => api.post('/discord/connect', { channel_id: String(channelId) }),
  ...
  playQueueIndex: (index) => api.post(`/discord/queue/${index}/play`),
  moveQueueTrack: (fromIndex, toIndex) => api.post('/discord/queue/move', { from_index: fromIndex, to_index: toIndex }),
  clearQueue: (keepCurrent = true) => api.delete('/discord/queue', { params: { keep_current: keepCurrent } }),
  shuffleQueue: () => api.post('/discord/queue/shuffle'),
